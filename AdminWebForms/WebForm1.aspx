<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" UnobtrusiveValidationMode="None" CodeBehind="WebForm1.aspx.cs" Inherits="AdminWebForms.WebForm1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <asp:CheckBox ID="cbIsRepresentative" runat="server" CssClass="is-representative-picture" Checked="false" />
    ...
    <div class="mb-3">
        <asp:Button class="btn btn-primary" OnClick="btnSubmit_Click" ID="btnSubmit" Text="Submit" runat="server" type="submit" />
    </div>
